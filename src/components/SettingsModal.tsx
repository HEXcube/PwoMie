...
export const SettingsModal: React.FC<SettingsModalProps> = ({ 
  ...
  const [tempWork, setTempWork] = useState<number>(initialWork);
  const [tempBreak, setTempBreak] = useState<number>(initialBreak);
            ...
            <div className="mb-6">
              ...
              <div className="relative w-full pb-2">
                <input 
                  ...
                  min="1" max="60" 
                  value={tempWork} 
                  onChange={(e) => { playClick(); setTempWork(Number(e.target.value)); }}
            ...
            <div className="mb-8">
              ...
              <div className="relative w-full pb-2">
                <input 
                  ...
                  min="1" max="30" 
                  value={tempBreak} 
                  onChange={(e) => { playClick(); setTempBreak(Number(e.target.value)); }}
